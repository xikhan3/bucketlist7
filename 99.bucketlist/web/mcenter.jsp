                            ...
                            <div>
	                            ...
	                            <div class="carousel-inner">
	                                <div class="item active">
	                                    <img class="slide-image" src="img/img01.jpg" alt="">
	                                </div>
	                                <div class="item">
	                                    <img class="slide-image" src="img/img02.jpg" alt="">
	                                </div>
	                                <div class="item">
	                                    <img class="slide-image" src="img/img03.jpg" alt="">
	                                </div>
	                                <div class="item">
	                                    <img class="slide-image" src="img/img02.jpg" alt="">
	                                </div>
            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a href="contentslist.bk" class="portfolio-link">
                        ...
                        <img src="bootstrap/img/portfolio/cabin.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="contentslistcategory.bk?categoryid=develop" class="portfolio-link">
                        ...
                        <img src="bootstrap/img/portfolio/cake.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="contentslistcategory.bk?categoryid=travel" class="portfolio-link">
                        ...
                        <img src="bootstrap/img/portfolio/circus.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="contentslistcategory.bk?categoryid=food" class="portfolio-link">
                        ...
                        <img src="bootstrap/img/portfolio/game.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="contentslistcategory.bk?categoryid=sports" class="portfolio-link">
                        ...
                        <img src="bootstrap/img/portfolio/safe.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="contentslistcategory.bk?categoryid=etc" class="portfolio-link">
                        ...
                        <img src="bootstrap/img/portfolio/submarine.png" class="img-responsive" alt="">
                    </a>
                </div>
            </div>
        </div>
