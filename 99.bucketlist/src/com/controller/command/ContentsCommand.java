...
public class ContentsCommand {
	...
	MultipartFile contents_image1;
	MultipartFile contents_image2;
	MultipartFile contents_image3;
	...
	public ContentsCommand(String user_id) {
		super();
		this.user_id = user_id;
	}


	public ContentsCommand(int contents_id, String user_id, String category_id,
			String contents_title, MultipartFile contents_image1,
			MultipartFile contents_image2, MultipartFile contents_image3,
	...
	public MultipartFile getContents_image1() {
		return contents_image1;
	}

	public void setContents_image1(MultipartFile contents_image1) {
		this.contents_image1 = contents_image1;
	}

	public MultipartFile getContents_image2() {
		return contents_image2;
	}

	public void setContents_image2(MultipartFile contents_image2) {
		this.contents_image2 = contents_image2;
	}

	public MultipartFile getContents_image3() {
		return contents_image3;
	}

	public void setContents_image3(MultipartFile contents_image3) {
		this.contents_image3 = contents_image3;
	}
	...
	public String toString() {
		return "ContentsCommand [contents_id=" + contents_id + ", user_id="
				+ user_id + ", category_id=" + category_id + ", contents_title="
				+ contents_title + ", contents_image1=" + contents_image1
				+ ", contents_image2=" + contents_image2 + ", contents_image3="
				+ contents_image3 + ", contents_content=" + contents_content
