...
public class UpdateContentsCommand {
	private int contents_id;
	private String user_id;
	private String category_id;
	private String contents_title;
	MultipartFile new_contents_image1;
	MultipartFile new_contents_image2;
	MultipartFile new_contents_image3;
	...
	public UpdateContentsCommand() {
		super();
	}

	public UpdateContentsCommand(int contents_id, String user_id,
			String category_id, String contents_title,
			MultipartFile new_contents_image1,
			MultipartFile new_contents_image2,
			MultipartFile new_contents_image3, String contents_image1,
		...
		this.new_contents_image1 = new_contents_image1;
		this.new_contents_image2 = new_contents_image2;
		this.new_contents_image3 = new_contents_image3;
	...
	public MultipartFile getNew_contents_image1() {
		return new_contents_image1;
	}

	public void setNew_contents_image1(MultipartFile new_contents_image1) {
		this.new_contents_image1 = new_contents_image1;
	}

	public MultipartFile getNew_contents_image2() {
		return new_contents_image2;
	}

	public void setNew_contents_image2(MultipartFile new_contents_image2) {
		this.new_contents_image2 = new_contents_image2;
	}

	public MultipartFile getNew_contents_image3() {
		return new_contents_image3;
	}

	public void setNew_contents_image3(MultipartFile new_contents_image3) {
		this.new_contents_image3 = new_contents_image3;
	}
	...
	public String toString() {
		return "UpdateContentsCommand [contents_id=" + contents_id
				+ ", user_id=" + user_id + ", category_id=" + category_id
				+ ", contents_title=" + contents_title
				+ ", new_contents_image1=" + new_contents_image1
				+ ", new_contents_image2=" + new_contents_image2
				+ ", new_contents_image3=" + new_contents_image3
