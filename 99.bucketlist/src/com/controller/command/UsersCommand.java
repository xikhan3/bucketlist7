...
public class UsersCommand {
	...
	public UsersCommand(String user_id, String user_password, String user_name,
			String user_email, MultipartFile user_image, Date user_regdate,
			boolean admin_check) {
	...
	public String toString() {
		return "UsersCommand [user_id=" + user_id + ", user_password="
				+ user_password + ", user_name=" + user_name + ", user_email="
				+ user_email + ", user_image=" + user_image + ", user_regdate="
